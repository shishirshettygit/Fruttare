...
public class ImageFromGalery extends Activity {
	String mImagesPath;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImagesPath = this.getFilesDir().getParent() + "/CachedImages/";
	...
	private void loadGridView() {
		...
		try {
			LazyImageAdapter lLazyAdapter = new LazyImageAdapter(
					this.getApplicationContext(), null, mImagesPath,
					ImageFromGalery.this);
	 ...
	 * 
	 * @param aPath
	 *            directory to check for and create
	 */
